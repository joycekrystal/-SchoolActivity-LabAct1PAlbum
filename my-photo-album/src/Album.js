...
const Album = () => {
    ...
    const secondGroup = [
        ...
        { id: 104, imgSrc: Img4 , title: 'CATS', description: '.'},
        { id: 105, imgSrc: Img5 , title: 'CATS', description: '.'},
        { id: 6, imgSrc: Img6 , title: 'CATS', description: '.'},
        { id: 7, imgSrc: Img7 , title: 'CATS', description: '.'},
        { id: 8, imgSrc: Img8 , title: 'CATS', description: '.'},
        { id: 9, imgSrc: Img9 , title: 'CATS', description: '.'},
        { id: 10, imgSrc: Img10 , title: 'CATS', description: '.'},
        { id: 11, imgSrc: Img101 , title: 'CATS', description: '.'},
        { id: 12, imgSrc: Img12 , title: 'CATS', description: '.'},
        { id: 13, imgSrc: Img13 , title: 'CATS', description: '.'},
        { id: 14, imgSrc: Img14 , title: 'CATS', description: '.'},
        { id: 15, imgSrc: Img15 , title: 'CATS', description: '.'},
        { id: 16, imgSrc: Img16 , title: 'CATS', description: '.'},
        { id: 17, imgSrc: Img17 , title: 'CATS', description: '.'},
        { id: 18, imgSrc: Img18 , title: 'CATS', description: '.'},
        { id: 18, imgSrc: Img18 , title: 'CATS', description: '.'},
        { id: 19, imgSrc: Img19 , title: 'CATS', description: '.'},
        { id: 20, imgSrc: Img20 , title: 'CATS', description: '.'},
      ];
